...
| **TC-03** | Usunięcie konta użytkownika i weryfikacja | Użytkownik jest zalogowany na swoje konto. | 1.Kliknij przycisk 'Delete Account.<br> 2. Konto zostaje usunięte. <br>3. **Przejdź do strony logowania i spróbuj zalogować się ponownie danymi **DATA-01**.| 1.Po usunięciu wyświetla się komunikat 'ACCOUNT DELETED!'.<br>2.**Próba zalogowania się na konto z **DATA-01** kończy się błędem: "Your email or password is incorrect!".** |
